...
const ProjectTableStyle = styled.table`
    margin-left: auto;
    margin-right: auto;
    border-spacing: max(20px, calc((25 / 1440) * 100vw));
`;
...
const Projects = () => {
    const SpotifyProject = (
        <Project
            ...
            description="Built an app to display a user's top artists and tracks, and provide them with custom playlists based on their recent musical tastes.  Utilized the Spotify API to allow a user to upload a generated playlist directly to their account."
            technologies="React &nbsp;&nbsp;&nbsp; Node.js &nbsp;&nbsp;&nbsp; Express &nbsp;&nbsp;&nbsp; Spotify API"
            githublink="https://github.com/olivervz/spotify-toolbox"
            link="https://spotify-toolbox.web.app"
        />
    );
    ...
    const projectAOSDurationMiddle = "1000";
    const projectAOSDurationBottom = "1000";
    const DesktopView = (
        <TableContainerStyle>
            <ProjectTableStyle>
                <TableRowStyle>
